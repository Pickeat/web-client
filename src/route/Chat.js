                ...
                <main className="flex-1 flex overflow-hidden">
                    <div className="flex-1 flex xl:overflow-hidden">
                        ...
                        <aside className="hidden lg:block lg:flex-shrink-0 flex-1">
                            <div
                                className="h-full relative flex flex-col border-l-2 border-solid border-black border-r border-gray-200 bg-white">
                                ...
                                {currentProductList.map((product, index) => {
                                    ...
                                    return (
                                        <li className="h-128 flex flex-col bg-white shadow overflow-hidden rounded-md">
                                            ...
                                            <div className="pt-4">
                                                <ReservationSection id={product?.title + "reservation-section"}
                                                                    product={product} ownId={Cookies.get('user_id')}/>
                                            </div>
                                        </li>
                                    )
                                })}
